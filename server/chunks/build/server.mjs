import { getCurrentInstance, hasInjectionContext, inject, shallowRef, computed, defineAsyncComponent, defineComponent, createElementBlock, provide, cloneVNode, h, ref, Suspense, Fragment, createApp, createVNode, Text, shallowReactive, toRef, onErrorCaptured, onServerPrefetch, unref, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, useSSRContext } from 'vue';
import { m as createError$1, s as klona, t as defuFn, v as sanitizeStatusCode, w as getContext, $ as $fetch$1, x as baseURL, y as createHooks, z as executeAsync, A as toRouteMatcher, B as createRouter$1, C as defu, D as getRequestURL, E as getRequestHeader, F as parse$1, o as destr, G as isEqual$1, H as setCookie, I as getCookie, J as deleteCookie } from '../nitro/nitro.mjs';
...
const LazyIcon = defineAsyncComponent(() => import('./index-CUutJytn.mjs').then((n) => n.i).then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CIaG-LyL.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CH-nTD_z.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, withoutTrailingSlash as c, nuxtLinkDefaults as d, entry$1 as default, useHead as e, useI18n as f, useRoute as g, hasProtocol as h, fetchDefaults as i, joinURL as j, useRequestFetch as k, withLeadingSlash as l, parseURL as m, navigateTo as n, encodeParam as o, parseQuery as p, encodePath as q, resolveRouteObject as r, useRequestEvent as s, asyncDataDefaults as t, useRouter as u, createError as v, withTrailingSlash as w, useAppConfig as x };
